...
describe('Confirmation dialog component', () => {
    ...
    function createComponent(data: Partial<ConfirmationDialogData> = {}) {
    ...
    describe('Button Appearances', () => {
        it('should have default appearances and correct classes', () => {
            createComponent()
        ...
        it('should use provided button appearances (new grouped properties) and apply classes', () => {
            createComponent({
    ...
    describe('Palette', () => {
        it('should have default primary palette', () => {
            createComponent()
            expect(component.confirmationThemePalette).toBe('primary')
        })

        it('should use provided palette (new grouped property)', () => {
            createComponent({
        ...
        it('should use deprecated confirmationThemePalette as fallback', () => {
            createComponent({
    ...
    describe('Keys and Translation', () => {
        it('should use new confirm/cancel keys', () => {
            createComponent({
        ...
        it('should fallback to deprecated keys', () => {
            createComponent({
                cancelKey: 'OldCancel',
    ...
    describe('Visibility', () => {
        ...
        it('should hide cancel icon when requested (new grouped property)', () => {
            createComponent({ cancel: { key: 'Cancel', hideIcon: true } })
            const icons = fixture.debugElement.queryAll(By.css('i'))
            expect(icons.length).toBe(1)
            expect(icons[0].nativeElement.className).toContain('fa-check')
        })

        it('should hide confirm icon when requested (new grouped property)', () => {
            createComponent({ confirm: { key: 'Confirm', hideIcon: true } })
            const icons = fixture.debugElement.queryAll(By.css('i'))
            expect(icons.length).toBe(1)
