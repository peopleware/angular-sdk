...
export interface PaginationOptions {
    ...
    /**
     * This default to `true`, meaning that the state in history will be replaced with the new URL.
     * It ensures that the user navigates to the previous page of the application when using the back button.
     * Set this to `false` when you want to add a new entry to the history stack instead of replacing the current one,
